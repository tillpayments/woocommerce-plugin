...
use TillPayments\Client\Callback\ChargebackData;
use TillPayments\Client\Callback\ChargebackReversalData;
use TillPayments\Client\Data\Customer;
use TillPayments\Client\Data\Result\CreditcardData;
use TillPayments\Client\Data\Result\IbanData;
use TillPayments\Client\Data\Result\PhoneData;
use TillPayments\Client\Data\Result\ResultData;
use TillPayments\Client\Data\Result\WalletData;
use TillPayments\Client\Exception\ClientException;
use TillPayments\Client\Schedule\ScheduleResult;
use TillPayments\Client\Exception\InvalidValueException;
use TillPayments\Client\Schedule\ScheduleError;
use TillPayments\Client\StatusApi\StatusResult;
